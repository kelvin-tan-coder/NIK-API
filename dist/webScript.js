...
//   event.preventDefault();
  ...
  const options = {
    method: "GET",
    headers: {
      "X-RapidAPI-Key": "cff69eb933msh618671fda54463bp1384dajsn8a062564c297",
  ...
  try {
    ...
    document.querySelector('#nik').innerHTML = `${input}`;
    document.querySelector('#nikTanggalLahir').innerHTML = `${hasil.results.parse_data.tanggal_lahir}`;
    document.querySelector('#nikUsia').innerHTML = `${hasil.results.parse_data.usiatext}`;
    document.querySelector('#nikKelamin').innerHTML = `${hasil.results.parse_data.jenis_kelamin}`;
    document.querySelector('#nikAlamat').innerHTML = `${hasil.results.realtime_data.findNikSidalih.alamat}`;
